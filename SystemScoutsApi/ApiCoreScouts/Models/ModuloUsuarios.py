...
class Persona(models.Model):
    ...
    ESC_ID = models.ForeignKey(Estado_Civil, on_delete=models.PROTECT, null=False)
    COM_ID = models.ForeignKey(Comuna, on_delete=models.PROTECT, null=False)
...
class Persona_Grupo(models.Model):
    ...
    GRU_ID = models.ForeignKey(Grupo, on_delete=models.PROTECT, null=False)
...
class Persona_Individual(models.Model):
    ...
    DIS_ID = models.ForeignKey(Distrito, on_delete=models.PROTECT, null=True)
    ZON_ID = models.ForeignKey(Zona, on_delete=models.PROTECT, null=True)
...
class Persona_Nivel(models.Model):
    ...
    PER_ID = models.ForeignKey('Persona', on_delete=models.PROTECT, null=False)
    NIV_ID = models.ForeignKey(Nivel, on_delete=models.PROTECT, null=False)
    RAM_ID = models.ForeignKey(Rama, on_delete=models.PROTECT, null=False)
...
class Persona_Curso(models.Model):
    ...
    ALI_ID = models.ForeignKey(Alimentacion, on_delete=models.PROTECT, blank=True, null=True)
    NIV_ID = models.ForeignKey(Nivel, on_delete=models.PROTECT, null=True)
