...
class Curso(models.Model):
    ...
    per_id_responsable = models.ForeignKey(Persona, on_delete=models.CASCADE, db_column='per_id_responsable', null=True, blank=True)
    car_id_responsable = models.ForeignKey(Cargo, on_delete=models.CASCADE, related_name='cargo_responsable', db_column='car_id_responsable', null=True, blank=True)
