...
class Archivo(models.Model):
    ...
    USU_ID_CREA = models.ForeignKey('ModuloUsuarios.Usuario', on_delete=models.PROTECT, related_name='usuario_crea', null=False)
    USU_ID_MODIFICA = models.ForeignKey('ModuloUsuarios.Usuario', on_delete=models.PROTECT, related_name='usuario_modifica', null=True)
...
class Archivo_Curso(models.Model):
    ...
    CUS_ID = models.ForeignKey('ModuloCursos.Curso', on_delete=models.PROTECT, null=False)
...
class Archivo_Persona(models.Model):
    ...
    CUS_ID = models.ForeignKey('ModuloCursos.Curso', on_delete=models.CASCADE, null=True)
