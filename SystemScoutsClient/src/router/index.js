...
const router = createRouter({
  ...
  { path: '/dashboard-2', name: 'dashboard2', component: Dashboard2, meta: { requiresAuth: false } },
    { path: '/usuarios', name: 'usuarios', component: UsuariosRoles, meta: { requiresAuth: false } },
  // Mantenedores admite pestaña vía parámetro opcional
  { path: '/mantenedores/:tab?', name: 'mantenedores', component: Mantenedores, props: true, meta: { requiresAuth: false } },
    { path: '/gestionpersonas', name: 'gestionpersonas', component: Gestionpersonas, meta: { requiresAuth: false } },
    { path: '/pagos', name: 'pagos', component: PagosView, meta: { requiresAuth: false } },
  { path: '/manual-acreditacion', name: 'manualacreditacion', component: ManualAcreditation, meta: { requiresAuth: false } },
  { path: '/verificador-qr', name: 'verificadorqr', component: VerificadorQR, meta: { requiresAuth: true, requiresAuth: false } },
    { path: '/correos', name: 'correos', component: Correos, meta: { requiresAuth: false } },
    { path: '/cursos-capacitaciones', name: 'cursoscapacitaciones', component: CursosCapacitaciones, meta: { requiresAuth: false } },
