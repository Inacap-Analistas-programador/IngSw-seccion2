<template>
  <div class="mantenedor-section">
    ...
    <div class="search-bar"><input type="text" class="search-input" v-model="search" placeholder="Buscar Nivel..."></div>
...
const abrirModalCrear = () => { editando.value = false; Object.assign(form, { id: null, descripcion: '', orden: 1, vigente: true }); modalVisible.value = true }
