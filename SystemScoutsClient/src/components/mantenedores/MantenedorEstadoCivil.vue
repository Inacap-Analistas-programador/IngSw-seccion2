<template>
  <div class="mantenedor-section">
    <div class="mantenedor-header">
      <h2><AppIcons name="users" :size="24" /> Gestión de Estado Civil</h2>
      <button class="btn-primary" @click="abrirModalCrear"><AppIcons name="plus" :size="18" /> Nuevo Estado Civil</button>
    </div>
    <div class="search-bar"><input type="text" class="search-input" v-model="search" placeholder="Buscar Estado Civil..."></div>
...
const abrirModalCrear = () => { editando.value = false; Object.assign(form, { id: null, descripcion: '', vigente: true }); modalVisible.value = true }
