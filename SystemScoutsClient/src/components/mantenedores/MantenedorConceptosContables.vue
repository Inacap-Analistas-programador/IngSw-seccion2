<template>
  <div class="mantenedor-section">
    ...
    <div class="search-bar"><input type="text" class="search-input" v-model="search" placeholder="Buscar Concepto..."></div>
...
const abrirModalCrear = () => { editando.value = false; Object.assign(form, { id: null, descripcion: '', tipo: '', vigente: true }); modalVisible.value = true }
